...
// We give our pseudocode; we check if distance covered forward(North) is cancelled out by distance going backwards(south) and if distance going left(west) is canceled out by distance going right(east)
