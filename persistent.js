...
// We give our pseudocode explanation; we convert to string, we then split into two elements, multiply and if greater than 9, we multiply the two numbers once more until single digit is the result of a product
