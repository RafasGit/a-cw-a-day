...
// We descirbe our code solution using non-technical terms; we accept the string input, loop through the string characters, check if the character is upper or lower case
